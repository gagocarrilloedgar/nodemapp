...
class Fork {
 ...
 String name;
  ...
  Fork(this.uuid, this.name, this.price, this.dateOfProduction, this.image,this.createdAt,this.updatedAt,this.deletedAt,
      this.providerId, this.stateId, this.bikeUuid);
  
  factory Fork.fromJson(Map<String, dynamic> json) => _$ForkFromJson(json);
  Map<String, dynamic> toJson() => _$ForkToJson(this);
